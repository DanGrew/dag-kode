 ...
 * ----------------------------------------
 */
package uk.dangrew.kode.friendly.controlsfx;
...
/**
 * The {@link FriendlyFileChooser} provides a friendlier interface to a {@link FileChooser} since the {@link
 * FileChooser} is final and launches graphical elements.
 */
public class FriendlyFileChooser {
    ...
    /**
     * {@link FileChooser#showSaveDialog(Window).}
     * @param ownerWindow the owner {@link Window}.
     * @return the {@link File} to save to.
     */
