...
import uk.dangrew.kode.javafx.utility.ListChangeUtility;
...
public class FunctionListChangeListenerImplTest {
   ...
   @Test public void shouldCallFunctionWhenAdded() {
      Change< String > change = ListChangeUtility.simpleAddChange(testList);
   ...
   @Test public void shouldIgnoreNullRemoveFunction() {
      ...
      Change< String > change = ListChangeUtility.simpleRemovedChange(testList.get( 3 ));
      systemUnderTest.onChanged( change );
   }//End Method
   ...
   @Test public void shouldCallFunctionWhenAddedAndRemoved() {
      Change< String > change = ListChangeUtility.simpleAddedAndRemovedChange(testList.subList(0, 3), Collections.singletonList(testList.get( 3 )));
      systemUnderTest.onChanged( change );
      for ( int i = 0; i < 3; i++ ) {
         Mockito.verify( addFunction ).accept( testList.get( i ) );
      }
