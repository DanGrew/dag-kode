...
public class ResponsiveComboLocalDatePropertyTest {

   @Mock private ChangeListener< LocalDate > listener;
   private ObservableList< LocalDate > items;
   private ResponsiveComboLocalDateProperty systemUnderTest;
   ...
   @Before public void initialiseSystemUnderTest() {
      ...
      systemUnderTest = new ResponsiveComboLocalDateProperty( items, items.get( 2 ), listener );
   }//End Method
